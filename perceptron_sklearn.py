...
from typing import List, Callable
    ...
    # data = ...
def perceptron(parametros:List[int],data: List[List[bool]],index: int):
    ...
    X_train, X_test, y_train, y_test = train_test_split(X_parametros, y, test_size=0.4,random_state=25)
